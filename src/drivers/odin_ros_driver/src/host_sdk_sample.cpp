...
static void lidar_device_callback(const lidar_device_info_t* device, bool attach)
{
	...
	std::string config_dir = "";
		...
		if (pos != std::string::npos) {
		    config_dir = workspace_path.substr(0, pos) + "/src/drivers/odin_ros_driver/config";
		} else {
    ...
    try {
        ...
        std::string map_dir = "";
            ...
            if (ros_workspace) {
                ...
                size_t pos = workspace_path.find("/install");
                if (pos != std::string::npos) {
                    data_dir = workspace_path.substr(0, pos) + "/src/drivers/odin_ros_driver/recorddata";
                    log_dir = workspace_path.substr(0, pos) + "/src/drivers/odin_ros_driver/log";
                    map_dir = workspace_path.substr(0, pos) + "/src/drivers/odin_ros_driver/map";
                } else {
