...
std::string map_frame, odom_frame, base_frame, lid_frame;
...
void readParameters(std::shared_ptr<rclcpp::Node> & nh)
{
  ...
  try {
    ...
    nh->declare_parameter<std::string>("common.map_frame", "map");
    nh->get_parameter("common.map_frame", map_frame);

    nh->declare_parameter<std::string>("common.odom_frame", "odom");
    nh->get_parameter("common.odom_frame", odom_frame);

    nh->declare_parameter<std::string>("common.base_frame", "base_link");
    nh->get_parameter("common.base_frame", base_frame);

    nh->declare_parameter<std::string>("common.lidar_frame", "lidar");
    nh->get_parameter("common.lidar_frame", lid_frame);
