...
def generate_launch_description():
    ...
    declare_prior_pcd_file_cmd = DeclareLaunchArgument(
        "prior_pcd_file",
        default_value=PathJoinSubstitution([point_lio_dir, "PCD", "taskyou.pcd"]),
    ...
    gicp_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'map_filter_x_min': '-2.5',
            'map_filter_x_max': '2.0',
            'map_filter_y_min': '-3.5',
            'map_filter_y_max': '-0.5',
            'relocalization_map_filter_x_min': '-1.0',
            'relocalization_map_filter_x_max': '7.0',
            'relocalization_map_filter_y_min': '-5.0',
            'relocalization_map_filter_y_max': '1.0',
            'relocalization_global_search_coarse_step': '1.5',
            ...
            'startup_yaw_prior_enabled': 'false',
            'startup_yaw_prior_deg': '0.0',
            'startup_yaw_prior_tolerance_deg': '60.0',
            'max_z_deviation': '1.5',
